component output="false" hint="Sets up the application and defines top level event handlers." {
	...
	this.datasources["blocklistprovider"] = {
		...
		, connectionString: 'jdbc:mysql://192.168.1.75:3306/blocklistprovider?useUnicode=true&characterEncoding=UTF-8&tinyInt1isBit=true&autoReconnect=true&jdbcCompliantTruncation=true&allowMultiQueries=false'
		, username: 'blocklist'
